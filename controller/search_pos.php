<?php
    ...
    $n = 1;  
?>
<h2>POS Report from '<?php echo date("jS M, Y", strtotime($from)) . "' to '" . date("jS M, Y", strtotime($to))?>'</h2>
    <hr>
    <div class="search">
...
<?php
    ...
    $amounts = $get_total->fetch_sum_2dateCond('payments', 'amount_paid', 'payment_mode', 'post_date', $from, $to, 'Pos');
