<?php
    ...
    // if(isset($_POST['change_prize'])){
       ...
       /*  $wholesale_pack = htmlspecialchars(stripslashes($_POST['wholesale_pack']));
        ...
        $change_price->update_tripple('items', 'cost_price', $cost_price, 'sales_price', $sales_price, /* 'pack_price', $pack_price, 'pack_size', $pack_size, */ 'wholesale', $wholesale, /* 'wholesale_pack', $wholesale_pack,  */'item_id', $item);
