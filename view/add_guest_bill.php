    ...
    <div class="add_user_form" style="width:50%; margin:10px 0">
        ...
        <!-- <form method="POST" id="addUserForm"> -->
            <section class="addUserForm add_bill" style="padding:20px 0">
                ...
                <a href="javascript:void" style="background:var(--otherColor)" title="add Bar & restaurant item" onclick="showPage('add_sales.php?customer=<?php echo $check_id?>')"><i class="fas fa-beer"></i> <i class="fas fa-cutlery"></i> Bar & Restaurant</a>
            </section>
