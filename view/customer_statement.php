...
<div id="stockin" class="displays" style="width:90%!important">
    <div class="add_user_form" style="width:50%; margin:10px 0;">
        <h3 style="background:var(--moreColor); text-align:left!important;" >Guest reports</h3>
        ...
        <section class="addUserForm">
            <div class="inputs">
                ...
                <div class="data" style="width:100%; margin:10px 0">
                    <input type="text" name="customer" id="customer" required placeholder="Input guest name" onkeyup="getCustomer(this.value)">
                        <div id="sales_item">
