<aside class="main_menu" id="mobile_log">
    ...
    <nav>
        ...
        <ul>
            ...
            <li id="adminMenu"><a href="javascript:void(0);" class="allMenus" title="Administrator Setup menu"><span><i class="fas fa-gem"></i> Admin menu</span> <span class="second_icon"><i class="fas fa-chevron-down more_option"></i></span></a>
                <ul class="subMenu">   
            ...
            <?php }?>
            <li id="frontDesk"><a href="javascript:void(0);" class="allMenus" title="Front desk menu" data-menu="frontDesk"><span><i class="fas fa-gem"></i> Front Desk </span><span class="second_icon"><i class="fas fa-chevron-down more_option"></i></span></a>
                <ul class="subMenu" >
            ...
            <li id="payments"><a href="javascript:void(0);" class="allMenus" title="payment menu" data-menu="payments"><span><i class="fas fa-gem"></i> Payments </span><span class="second_icon"><i class="fas fa-chevron-down more_option"></i></span></a>
                <ul class="subMenu">
            ...
            <li id="reports"><a href="javascript:void(0);" class="allMenus" title="General Reports" data-menu="reports"><span><i class="fas fa-gem"></i> Reports </span><span class="second_icon"><i class="fas fa-chevron-down more_option"></i></span></a>
                <ul class="subMenu">
            ...
            <li id="financial_reports"><a href="javascript:void(0);" class="allMenus" title="Financial Reports" data-menu="financial_reports"><span><i class="fas fa-gem"></i> Financial Reports </span><span class="second_icon"><i class="fas fa-chevron-down more_option"></i></span></a>
                <ul class="subMenu">
